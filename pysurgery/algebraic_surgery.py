...
class AlgebraicSurgeryComplex(BaseModel):
    ...
    def assembly_map_result(
        self, pi_1_group: str = "1", form: Optional[Any] = None
    ) -> ObstructionResult:
    ...
    def assembly_map(self, pi_1_group: str = "1", form: Optional[Any] = None) -> Any:
    ...
    def s_cobordism_torsion(self, cw_complex: Any) -> str:
