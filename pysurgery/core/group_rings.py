...
class GroupRingElement:
    ...
    def __add__(self, other: 'GroupRingElement') -> 'GroupRingElement':
        ...
        for g, c in other.coeffs.items():
            res[g] = res.get(g, 0) + c
        return GroupRingElement(res, self.group_order, self.group_law, self.inverse_law)
    ...
    def __mul__(self, other: 'GroupRingElement') -> 'GroupRingElement':
        ...
        if julia_engine.available:
            ...
            return GroupRingElement(res_coeffs, self.group_order, self.group_law, self.inverse_law)
    ...
    def involution(self) -> 'GroupRingElement':
        ...
        for g, c in self.coeffs.items():
            ...
            if gn == '1':
                ...
                result[f"{gn}^-1"] = c
        return GroupRingElement(result, self.group_order, self.group_law, self.inverse_law)
