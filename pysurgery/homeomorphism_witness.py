...
class HomeomorphismWitness:
    ...
    Overview:
        A HomeomorphismWitness is a formal certificate that provides the 
        mathematical evidence and theoretical justification for the 
        homeomorphism between two manifolds. It bundles together the theorem 
        used, the specific invariants checked, and any explicit maps or 
        isometries discovered.

    Key Concepts:
        - **Witness Kind**: Categorization of the proof (e.g., surface 
          classification, s-cobordism).
        - **Evidence**: Specific invariant matches (Betti numbers, π₁, etc.).
        - **Certificates**: Sub-certificates like lattice isometry matrices 
          or 3-manifold recognition results.
        - **Theorem Tag**: A formal identifier for the underlying topological 
          theorem (e.g., [THM:S-COBORDISM]).

    Common Workflows:
        1. **Creation** → Generated by specific build_*_witness functions.
        2. **Verification** → Review .evidence and .assumptions for correctness.
        3. **Export** → Serialize as part of a topological certificate.

    Attributes:
        dimension (int): Manifold dimension.
        theorem (str): Name of the theorem (e.g., "Freedman classification").
        kind (WitnessKind): The classification strategy used.
        description (str): Human-readable summary.
        exact (bool): True if the proof is mathematically rigorous.
        evidence (List[str]): List of specific invariant matches.
        assumptions (List[str]): List of assumptions made during analysis.
        certificates (Dict[str, object]): Detailed mathematical sub-certificates.
        explicit_map (Optional[np.ndarray]): Numerical representation of the map.
        theorem_tag (Optional[str]): Tag for the theorem used.
        contract_version (str): The version of the witness contract.
    """
...
class HomeomorphismWitnessResult:
    ...
    Overview:
        Wraps a HomeomorphismWitness with metadata about the building process, 
        including reasoning for failures or inconclusive results.

    Attributes:
        status (str): "success", "inconclusive", or "surgery_required".
        reasoning (str): Human-readable reasoning for the status.
        witness (Optional[HomeomorphismWitness]): The built HomeomorphismWitness, if successful.
        theorem (Optional[str]): The theorem used.
        theorem_tag (Optional[str]): Tag for the theorem.
        contract_version (str): Version of the contract.
        source_result (Optional[HomeomorphismResult]): The original HomeomorphismResult.
        missing_data (List[str]): List of data that was missing for a successful witness.
    """
...
def build_homeomorphism_witness(
    ...
    *,
    ...
    What is Being Computed?:
        A comprehensive HomeomorphismWitness by identifying the manifold 
        dimension and selecting the appropriate classification theorem.

    Algorithm:
        1. If 4D intersection forms are provided, call build_4d_homeomorphism_witness.
        2. Otherwise, check the dimension:
           - 1D: Classification of 1-Manifolds.
           - 2D: Classification of Closed Surfaces.
           - 3D: Geometrization / Poincaré Conjecture.
           - 5D+: Surgery Theory / s-Cobordism.
        3. Validate that all required data (chain complexes, π₁, etc.) is present.

    Preserved Invariants:
        - Homeomorphism is the strongest equivalence in the topological category.
        - Successful witness construction implies isomorphism of all lower 
          invariants (homology, homotopy).
    ...
    Use When:
        - You need a formal certificate of homeomorphism for a pair of spaces.
        - Automating the classification of manifolds across different dimensions.
    """
