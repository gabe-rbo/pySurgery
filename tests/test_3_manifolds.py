...
def test_lens_space_L31_homology():
    ...
    cc = ChainComplex(boundaries={1: d1, 2: d2, 3: d3}, dimensions=[0, 1, 2, 3], cells={0: 1, 1: 1, 2: 1, 3: 1})
...
def test_poincare_homology_sphere():
    ...
    cc_phs = ChainComplex(boundaries={1: d1, 2: d2, 3: d3}, dimensions=[0, 1, 2, 3], cells={0: 1, 1: 0, 2: 0, 3: 1})
    cc_s3 = ChainComplex(boundaries={1: d1, 2: d2, 3: d3}, dimensions=[0, 1, 2, 3], cells={0: 1, 1: 0, 2: 0, 3: 1})
